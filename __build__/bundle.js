...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detectTouch = __webpack_require__(168);
	...
	function App() {
	  function runTest(test, result) {
	    ...
	    var resultAsString = typeof result === 'undefined' ? 'undefined' : result.toString();
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'test-result' },
	        runTest('window.DocumentTouch && document instanceof DocumentTouch', window.DocumentTouch && document instanceof DocumentTouch)
	      )
	    )
	  );
	}
